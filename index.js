...
let cansLeft = 8; // Any number of cans
console.log(cansLeft < 5 ? "Time to stock" : "We're stocked!");
...
// Otherwise, print "Better stick to water."
 ...
 console.log(currentHour < 7 && 24 ? "Unleash the beast!" : "Better stick to water");
